...
function GF_LoadSettings()
	...
	if GF_SavedVariables.MainFrameXPos then GF_MainFrame:SetPoint("CENTER",UIParent,"CENTER", GF_SavedVariables.MainFrameXPos, GF_SavedVariables.MainFrameYPos) end -- Changed from TOPLEFT to CENTER
	if GF_PerCharVariables.DPSMeterXPos then GF_DamageMeterFrame:SetPoint("CENTER",UIParent,"CENTER", GF_PerCharVariables.DPSMeterXPos, GF_PerCharVariables.DPSMeterYPos) end -- Changed from TOPLEFT to CENTER
...
function GF_SetStringSize()
	...
	"GF_ResetAllSettingsButton","GF_AddPlayerButton","GF_BlackListFramePageLabel","GF_WhisperLogButton","GF_GroupLogButton","GF_MinimapIconTextLabel","GF_AddPlayerFrameOkButton","GF_AddPlayerFrameCloseButton","GF_ResetAllSettingsDialogOkButton","GF_BlockAddListButton",}
	...
	"GF_GroupChannelNameTextLabel","GF_BlockListTextLabel","GF_ResultsLabel", }
...
-- arg1(message),arg2(sender),arg3(language),arg4("Channel#." "(City/Trade)" "channelName"),arg5(target/nameoflooter),arg6(afk/dnd flags),arg7(zoneChannel#),arg8(channel#),arg9("City/Trade" "channelName"),arg10(?),arg11(lineID),arg12(sender guid),arg13(bnetID)
		...
		if not arg1 or not GF_TextColors[strsub(event,10)] or (arg9 and strlower(arg9) == "lft") then old_ChatFrame_OnEvent(self,event,...) return end -- Changed
...
function GF_CheckForDelayedMessages()
	for i=1,#GF_LogHistory[GF_RealmName]["Delay"] do
		if GF_LogHistory[GF_RealmName]["Delay"][i] then
			if GF_LogHistory[GF_RealmName]["Delay"][i][1] == "Log" and (not GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][6]] or GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][6]] + 2 < time()) and (GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][6]] or GF_LogHistory[GF_RealmName]["Delay"][i][2] < time()) then
				...
				i = i - 1
			elseif GF_LogHistory[GF_RealmName]["Delay"][i][1] == "Channel" and (not GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] + 2 < time()) and (GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_LogHistory[GF_RealmName]["Delay"][i][2] < time()) then
				...
				table.remove(GF_LogHistory[GF_RealmName]["Delay"],i)
				i = i - 1
			elseif GF_LogHistory[GF_RealmName]["Delay"][i][1] == "Chat" and (not GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] + 2 < time()) and (GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_LogHistory[GF_RealmName]["Delay"][i][2] < time()) then
				if not GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]][1] == 0 or GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]][1] >= GF_SavedVariables.blockmessagebelowlevel then
				...
				table.remove(GF_LogHistory[GF_RealmName]["Delay"],i)
				i = i - 1
			elseif GF_LogHistory[GF_RealmName]["Delay"][i][1] == "Whisper" and (not GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] + 2 < time()) and (GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_LogHistory[GF_RealmName]["Delay"][i][2] < time()) then
				...
				table.remove(GF_LogHistory[GF_RealmName]["Delay"],i)
				i = i - 1
			elseif GF_LogHistory[GF_RealmName]["Delay"][i][1] == "Minimap" and (not GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_SavedVariables.friendsToRemove[GF_LogHistory[GF_RealmName]["Delay"][i][4]] + 2 < time()) and (GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_LogHistory[GF_RealmName]["Delay"][i][2] < time()) then
				if not GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]] or GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]][1] == 0 or GF_WhoTable[GF_RealmName][GF_LogHistory[GF_RealmName]["Delay"][i][4]][1] >= GF_SavedVariables.blockmessagebelowlevel then
...
function GF_GetWhoData(arg2,groupfound)
	...
	and (not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][4] + 1209600 < time() or (GF_WhoTable[GF_RealmName][arg2][1] < 60 and GF_WhoTable[GF_RealmName][arg2][4] + 86400 < time())) then -- If level 60, get new whodata after 14 days(for guild name changes). If below level 60, get new data every 24 hours.
		if GF_SavedVariables.usefriendslist and not GF_SavedVariables.friendsToRemove[arg2] then GF_WhoTable[GF_RealmName][arg2] = nil end
...
function GF_Frame:COMBAT_LOG_EVENT_UNFILTERED(event,tim,token,sourceGUID,source,sourceFlag,targetGUID,target,targetFlag,value,spellName,spellType,amount,over) -- TBC/WOTLK process
	...
	if parseFunc then
		...
		elseif GF_PetCurrentlyInGroup[source] then
			parseFunc(GF_PetCurrentlyInGroup[source][1],target,amount or value,over)
		end
	end
end
...
function GF_CHAT_MSG_BATTLEGROUND(event,arg1,arg2,arg8,arg9)
...
function GF_CHAT_MSG_BATTLEGROUND_LEADER(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][1] == 0 then GF_UpdateGroup() end
	GF_AddLogMessage(arg1,4,true,arg2,arg8,arg9,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
...
function GF_CHAT_MSG_COMBAT_FACTION_CHANGE(event,arg1,arg2,arg8,arg9)
...
function GF_CHAT_MSG_COMBAT_HONOR_GAIN(event,arg1,arg2,arg8,arg9)
	GF_AddLogMessage(arg1,6,true,"SYSTEM",arg8,arg9,strsub(event,10))
	if GF_SavedVariables.showloottexts then GF_PreviousMessage["SYSTEM"] = {true} else GF_PreviousMessage["SYSTEM"] = {} end
end
function GF_CHAT_MSG_COMBAT_XP_GAIN(event,arg1,arg2,arg8,arg9)
	GF_AddLogMessage(arg1,6,true,"SYSTEM",arg8,arg9,strsub(event,10))
	if GF_SavedVariables.showloottexts then GF_PreviousMessage["SYSTEM"] = {true} else GF_PreviousMessage["SYSTEM"] = {} end
end
function GF_CHAT_MSG_EMOTE(event,arg1,arg2,arg8,arg9)
	GF_CheckForEmotes(arg1,arg2)
end
function GF_CHAT_MSG_GUILD(event,arg1,arg2,arg8,arg9)
	GF_WhisperReceivedAddToWhisperHistoryList(arg1,arg2,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_HARDCORE(event,arg1,arg2,arg8,arg9)
	GF_ProcessChatMessages(event,arg1,arg2,arg8,arg9)
end
function GF_CHAT_MSG_LOOT(event,arg1,arg2,arg8,arg9)
	GF_AddLogMessage(arg1,6,true,"SYSTEM",arg8,arg9,strsub(event,10))
	GF_CheckForLoot(arg1)
end
function GF_CHAT_MSG_MONEY(event,arg1,arg2,arg8,arg9)
	GF_AddLogMessage(arg1,6,true,"SYSTEM",arg8,arg9,strsub(event,10))
	if GF_SavedVariables.showloottexts then GF_PreviousMessage["SYSTEM"] = {true} else GF_PreviousMessage["SYSTEM"] = {} end
end
function GF_CHAT_MSG_MONSTER_EMOTE(event,arg1,arg2,arg8,arg9)
	GF_CheckForMonsterEmote(arg1,arg2)
end
function GF_CHAT_MSG_MONSTER_SAY(event,arg1,arg2,arg8,arg9)
	GF_CheckForMonsterEmote(arg1,arg2)
end
function GF_CHAT_MSG_MONSTER_YELL(event,arg1,arg2,arg8,arg9)
	GF_CheckForMonsterEmote(arg1,arg2)
end
function GF_CHAT_MSG_OFFICER(event,arg1,arg2,arg8,arg9)
	GF_WhisperReceivedAddToWhisperHistoryList(arg1,arg2,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_PARTY(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][1] == 0 then GF_UpdateGroup() end
	GF_AddLogMessage(arg1,4,true,arg2,arg8,arg9,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_RAID(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][1] == 0 then GF_UpdateGroup() end
	GF_AddLogMessage(arg1,4,true,arg2,arg8,arg9,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_RAID_LEADER(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][1] == 0 then GF_UpdateGroup() end
	GF_AddLogMessage(arg1,4,true,arg2,arg8,arg9,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_RAID_WARNING(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] or GF_WhoTable[GF_RealmName][arg2][1] == 0 then GF_UpdateGroup() end
	GF_AddLogMessage(arg1,4,true,arg2,arg8,arg9,strsub(event,10))
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_SAY(event,arg1,arg2,arg8,arg9)
	GF_ProcessChatMessages(event,arg1,arg2,arg8,arg9)
end
function GF_CHAT_MSG_SYSTEM(event,arg1,arg2,arg8,arg9)
...
function GF_CHAT_MSG_TEXT_EMOTE(event,arg1,arg2,arg8,arg9)
	GF_CheckForEmotes(arg1,arg2)
end
function GF_CHAT_MSG_WHISPER(event,arg1,arg2,arg8,arg9)
...
function GF_CHAT_MSG_WHISPER_INFORM(event,arg1,arg2,arg8,arg9)
	if not GF_WhoTable[GF_RealmName][arg2] and GF_PlayingOnTurtle and GF_SavedVariables.usewhoongroups and GF_SavedVariables.usefriendslist then GF_GetWhoData(arg2) end
	GF_WhisperReceivedAddToWhisperHistoryList(arg1,arg2,strsub(event,10))
	table.insert(DEFAULT_CHAT_FRAME.editBox.lastTell,1,arg2)
	GF_PreviousMessage[arg2] = {true}
end
function GF_CHAT_MSG_YELL(event,arg1,arg2,arg8,arg9)
	GF_ProcessChatMessages(event,arg1,arg2,arg8,arg9)
end
